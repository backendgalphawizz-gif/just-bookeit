...
/* Chat */
.vp-chat-item { display: block; padding: 1rem 1.15rem; border-bottom: 1px solid var(--vp-border); text-decoration: none; color: inherit; transition: background .15s; }
.vp-chat-item:hover, .vp-chat-item--active { background: var(--vp-orange-soft); }
.vp-chat-thread { min-height: 380px; max-height: 520px; overflow-y: auto; padding: 1rem; background: #fafbfc; }
.vp-msg { max-width: 72%; padding: .8rem 1rem; border-radius: 16px; margin-bottom: .85rem; font-size: .9rem; line-height: 1.45; }
.vp-msg--mine { margin-left: auto; background: var(--vp-teal); color: #fff; border-bottom-right-radius: 4px; }
.vp-msg--theirs { background: #fff; border: 1px solid var(--vp-border); border-bottom-left-radius: 4px; }
.vp-msg-time { font-size: .7rem; opacity: .75; margin-top: .35rem; }
