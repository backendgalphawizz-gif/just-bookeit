...
@section('content')
<div class="vp-auth-card" style="max-width:520px;text-align:left;">
    ...
    <form method="POST" action="{{ route('vendor.register.submit') }}" enctype="multipart/form-data" class="vp-auth-form">
        ...
        <div class="vp-field">
            ...
            <input type="text" name="shop_name" class="vp-input @error('shop_name') vp-input--error @enderror" value="{{ old('shop_name') }}" required maxlength="100" data-vp-restrict="title">
        ...
        <div class="vp-field">
            ...
            <input type="text" name="owner_name" class="vp-input @error('owner_name') vp-input--error @enderror" value="{{ old('owner_name') }}" required maxlength="100" data-vp-restrict="person-name">
            @error('owner_name')<p class="vp-field-error">{{ $message }}</p>@enderror
        </div>
        <div class="vp-field">
            <label class="vp-label">Email <span class="vp-required">*</span></label>
            <input type="email" name="email" class="vp-input @error('email') vp-input--error @enderror" value="{{ old('email') }}" required maxlength="255" data-vp-restrict="email">
            @error('email')<p class="vp-field-error">{{ $message }}</p>@enderror
        </div>
        <div class="vp-field">
            <label class="vp-label">City</label>
            <input type="text" name="city" class="vp-input @error('city') vp-input--error @enderror" value="{{ old('city') }}" maxlength="100" data-vp-restrict="city">
        ...
        <div class="vp-field">
            ...
            <input type="file" name="aadhar_front" class="vp-file" accept="image/jpeg,image/jpg,image/png,image/webp" required>
        ...
        <div class="vp-field">
            ...
            <input type="file" name="aadhar_back" class="vp-file" accept="image/jpeg,image/jpg,image/png,image/webp" required>
