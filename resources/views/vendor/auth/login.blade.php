...
<div class="vp-auth-card">
    ...
    <h1 class="vp-auth-title">Welcome Back</h1>
    <p class="vp-auth-sub">Enter your mobile number to continue</p>
    ...
    <form method="POST" action="{{ route('vendor.otp.send') }}" class="vp-auth-form">
        ...
        <button type="submit" class="vp-btn vp-btn--primary vp-btn--block" style="padding:.85rem;">Continue</button>
    </form>

    <div class="vp-divider">Or continue with</div>
    <button type="button" class="vp-social-btn" disabled>
    ...
    <p class="vp-auth-footer">
        New to Vendor Partner? <a href="{{ route('vendor.register') }}">Sign up</a>
    </p>
</div>
@endsection
