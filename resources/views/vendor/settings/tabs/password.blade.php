...
<form method="POST" action="{{ route('vendor.settings.password') }}">
    ...
    <div class="vp-field">
        ...
        <div class="vp-input-icon-wrap">
            ...
            <input id="password" type="password" name="password" class="vp-input @error('password') vp-input--error @enderror" placeholder="Enter new password" required minlength="8" autocomplete="new-password">
