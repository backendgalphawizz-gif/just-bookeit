<header class="jbw-header" x-data="{ mobileOpen: false, locationOpen: false, locationSearch: '', notificationOpen: false }" @keydown.escape.window="mobileOpen = false; locationOpen = false; notificationOpen = false">
    ...
    <rect x="14" y="14" width="7" height="7" rx="1"></rect>
        ...
        @auth('customer')
            <div class="jbw-mobile-nav-user">
                ...
                @else
                    <a href="{{ route('web.profile.edit') }}" class="jbw-mnav-link" @click="mobileOpen=false"><svg xmlns="http://www.w3.org/2000/svg"
     width="18"
     height="18"
     fill="none"
     viewBox="0 0 24 24"
    ...
    <circle cx="12" cy="7" r="4" />
                    ...
                    <!-- <a href="{{ route('web.bookings.index') }}" class="jbw-mnav-link" @click="mobileOpen=false"><svg xmlns="http://www.w3.org/2000/svg"
     width="18"
     height="18"
     fill="none"
     viewBox="0 0 24 24"
    ...
    <line x1="3" y1="10" x2="21" y2="10"></line>
                ...
                <form method="POST" action="{{ route('web.logout') }}">@csrf
                    <button type="submit" class="jbw-mnav-link jbw-mnav-link--danger" style="width:100%;text-align:left"><svg xmlns="http://www.w3.org/2000/svg"
     width="18"
     height="18"
     fill="none"
     viewBox="0 0 24 24"
