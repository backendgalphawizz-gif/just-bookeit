...
<div
    class="jbw-location-picker"
    id="jbw-location-picker"
    data-detect-url="{{ route('web.location.detect') }}"
    data-auto-detect="{{ ! empty($webLocationAutoDetect) ? '1' : '0' }}"
>
    <button
        type="button"
    ...
    >
        ...
        <span class="jbw-location-btn-label" data-location-label>{{ $webLocationLabel }}</span>
    </button>
    ...
    >
        ...
        <div class="jbw-location-section">
            <button type="button" class="jbw-location-option jbw-location-detect-btn" data-location-detect>
                <span class="jbw-location-option-label">Use current location</span>
                <span class="jbw-location-option-meta" data-location-detect-status>Detect from your device</span>
            </button>
        </div>
