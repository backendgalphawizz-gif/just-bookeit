...
<div class="jbw-location-picker">
    <button
        type="button"
        class="jbw-location-btn"
        @click="locationOpen = !locationOpen; notificationOpen = false"
        :aria-expanded="locationOpen"
        aria-haspopup="listbox"
    >
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M12 21s7-4.5 7-10a7 7 0 10-14 0c0 5.5 7 10 7 10z"/><circle cx="12" cy="11" r="2.5"/></svg>
