        ...
        <div class="jb-card-body">
            ...
            @elseif ($tab === 'contact')
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    @include('admin.partials.form-input', ['label' => 'Support phone', 'name' => 'support_phone', 'value' => old('support_phone', $values['support_phone'] ?? ''), 'restrict' => 'phone', 'hint' => '10 digits starting with 6–9'])
