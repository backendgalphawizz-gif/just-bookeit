    ...
    protected function statCards(array $stats, Admin $admin): array
    {
        $cards = [
            ...
            [
                'key' => 'total_vendors',
                'label' => 'Total Vendors',
                'value' => number_format($stats['total_vendors']),
                'tone' => 'violet',
                'permission' => 'vendors',
            ...
            [
                ...
                'value' => number_format($stats['active_vendors']),
                'tone' => 'emerald',
                'permission' => 'vendors',
                'url' => route('admin.vendors.index', ['status' => 'active']),
            ],
            [
                'key' => 'pending_vendor_approvals',
                'label' => 'Pending Vendor Approvals',
                'value' => number_format($stats['pending_vendor_approvals']),
                'tone' => 'amber',
                'permission' => 'vendors',
                'url' => route('admin.vendors.index', ['status' => 'pending']),
            ],
            [
                'key' => 'total_orders',
                'label' => 'Total Orders',
            ...
            [
                ...
                'value' => number_format($stats['orders_in_progress']),
                'tone' => 'sky',
                'permission' => 'orders',
                'url' => route('admin.orders.index', ['status' => '_in_progress_']),
            ],
            [
                ...
                'tone' => 'teal',
                'permission' => 'orders',
                'url' => route('admin.orders.index', ['status' => 'delivered']),
            ],
            [
                'key' => 'cancelled_orders',
                'label' => 'Cancelled Orders',
                'value' => number_format($stats['cancelled_orders']),
                'tone' => 'rose',
                'permission' => 'orders',
            ...
            [
                ...
                'tone' => 'indigo',
                'permission' => 'payments',
                'url' => route('admin.payments.index', ['payment_status' => 'success']),
            ],
            [
                'key' => 'refund_requests',
                'label' => 'Refund Requests',
                'value' => number_format($stats['refund_requests']),
                'tone' => 'orange',
                'permission' => 'refunds',
                'url' => route('admin.refunds.index', ['status' => '_open_']),
            ],
        ];
    ...
    protected function quickActions(Admin $admin): array
    {
        ...
        $actions = [
            ...
            [
                ...
                'route' => route('admin.orders.index', ['status' => '_in_progress_']),
            ],
            [
                'label' => 'Create Banner',
