...
class AdminValidationRules
{
    ...
    public static function customer(): array
    {
        return [
            ...
            'email' => self::emailRules(false),
            'address' => ['nullable', 'string', 'max:1000', 'regex:'.self::REGEX_TEXT],
            'city' => ['nullable', 'string', 'max:100', 'regex:'.self::REGEX_CITY],
            'state' => ['nullable', 'string', 'max:100', 'regex:'.self::REGEX_CITY],
            'country' => ['nullable', 'string', 'max:100', 'regex:'.self::REGEX_CITY],
            'pincode' => self::pincodeRules(),
            ...
            'state_other' => ['nullable', 'string', 'max:100'],
    ...
    public static function portfolioItem(bool $creating = false, ?string $typeSlug = null): array
    {
        ...
        $rules = [
            ...
            'title' => ['required', 'string', 'max:255', 'regex:'.self::REGEX_TITLE, WordLimit::rule(24)],
            'description' => ['nullable', 'string', 'max:5000', WordLimit::rule(150)],
    ...
    public static function messages(): array
    {
        return [
            ...
            'title.max_words' => 'Title may not be greater than 24 words.',
            'description.max_words' => 'Description may not be greater than 150 words.',
            ...
            'profile_image.uploaded' => 'Image is too large. Maximum size is 4 MB. Please choose a smaller file.',
            ...
            'shop_logo.uploaded' => 'Shop logo is too large. Maximum size is 4 MB. Please choose a smaller file.',
            'shop_images.*.max' => 'One or more shop images are too large. Maximum size is 4 MB each.',
            'shop_images.*.uploaded' => 'One or more shop images are too large. Maximum size is 4 MB each.',
